...
const GET_TICKET_BY_ID = 'SELECT gestionagil_prodDB.tickets.id_ticket, gestionagil_prodDB.tickets.id_machine, CONCAT(  gestionagil_prodDB.users.name , " ", gestionagil_prodDB.users.last_name ) as id_user, gestionagil_prodDB.tickets.description_ticket, gestionagil_prodDB.tickets.status, gestionagil_prodDB.tickets.created_at, gestionagil_prodDB.tickets.updated_at, gestionagil_prodDB.tickets.ticket_comments , gestionagil_prodDB.tickets.ticket_historial  , gestionagil_prodDB.tickets.ticket_name , gestionagil_prodDB.tickets.priority , CONCAT( u.name , " ",u.last_name ) as assigned_to FROM gestionagil_prodDB.tickets JOIN gestionagil_prodDB.users ON gestionagil_prodDB.tickets.id_user = gestionagil_prodDB.users.id_user JOIN gestionagil_prodDB.users u ON gestionagil_prodDB.tickets.assigned_to = u.id_user WHERE gestionagil_prodDB.tickets.id_ticket = '
