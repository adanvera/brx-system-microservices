...
GET_MACHINE_BY_ID= "SELECT id_machine, status, porcentaje, id_model FROM gestionagil_prodDB.miningmachines WHERE gestionagil_prodDB.miningmachines.id_machine = ";
